...
export default function SourcesIndexPage() {
    ...
    const SortIcon = ({ col }: { col: typeof sortBy }) => {
        if (sortBy !== col) return <span className="material-symbols-outlined text-[14px] text-text-muted">unfold_more</span>;
        return <span className="material-symbols-outlined text-[14px] text-amber">{sortDir === "desc" ? "arrow_downward" : "arrow_upward"}</span>;
    };
            ...
            <header className="border-b border-border bg-surface/40 backdrop-blur-xl sticky top-0 z-20">
                <div className="max-w-7xl mx-auto px-6 py-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <span className="badge badge-system">{filtered.length} sources</span>
                    </div>
                </div>
            </header>
                ...
                <div className="card p-0 overflow-hidden">
                    {loading ? (
                        ...
                        <div className="p-12 text-center">
                            <span className="material-symbols-outlined text-4xl text-text-muted mb-3 block">travel_explore</span>
                        ...
                        <>
                            <div className="overflow-x-auto">
                                <table className="w-full text-sm">
                                    <thead>
                                        <tr className="border-b border-border bg-surface/50 text-xs text-text-muted uppercase tracking-wider">
                                    ...
                                    <tbody>
                                        {pageData.map((source) => {
                                            ...
                                            const credColor = credPct !== null ? (credPct >= 70 ? "bg-emerald" : credPct >= 40 ? "bg-gold" : "bg-rose") : "bg-border";

                                            return (
                                                <tr key={source.source_url} className="border-b border-border hover:bg-surface-hover transition-colors">

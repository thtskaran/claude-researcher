  ...
  return (
    <div className="min-h-screen bg-dark-bg">
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        {activeTab === "findings" && (
          <div className="card">
            <h2 className="text-2xl font-bold mb-6">Research Findings</h2>
            <div className="text-center py-12 text-gray-400">
              ...
              <p className="text-lg">Findings view coming soon</p>
              <p className="text-sm mt-2">Will show extracted facts, sources, and confidence scores</p>
            </div>
          </div>
        )}
